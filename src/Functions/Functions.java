...
*
        ...
        But when we assign objects, it's a bit different than assigning primitives. s1 and joe are two different references to the same object.
        s1 == joe is true. This means that running methods on s1 will change the object joe.
        But if we'll change the value of s1 as a reference, it will not affect the reference joe.
