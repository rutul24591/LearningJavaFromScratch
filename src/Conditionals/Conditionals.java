...
CONDITIONALS
   ...
   Of course we don't normally assign a conditional expression to a boolean.
   Normally, we just use the short version:
    ...
    we strongly recommend for beginners not to use this short version of statements and to always use the full version with {}.
    ...
    you should use the `equals` method on the object. For example:
